                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                            ...
                            border: Border(bottom: BorderSide(color: Color(0xFFDDA0DD), width: 2.0,),)
                        ),
                        child: Row(
                          children: [
                            const Icon(Icons.location_on, color: Colors.white70),
                            const Text(" Delivering to ", style: TextStyle(color: Colors.white70),),
                            const Text("140603", style: TextStyle(color: Colors.white70, fontWeight: FontWeight.bold)),
                            const Spacer(),
                            GestureDetector(
                              onTap: (){
                          ...
                          children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      ...
                                                      child: const Icon(Icons.delete_outline, color: Color(0xFF452c63),),
                                                    ),
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text("Proceed to Buy", style: TextStyle(fontSize: 18, color: Colors.white70),),
                              ),
                            ),
                          ],
                        ),
